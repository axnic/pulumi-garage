...
class ProviderArgs:
    def __init__(
        __self__, *, itsasecret: Optional[pulumi.Input[_builtins.bool]] = None
    ):
        """
...
class Provider(pulumi.ProviderResource):
    ...
    def _internal_init(
        ...
        if opts.id is None:
            ...
            __props__.__dict__["itsasecret"] = (
                pulumi.Output.from_input(itsasecret).apply(pulumi.runtime.to_json)
                if itsasecret is not None
                else None
            )
        super(Provider, __self__).__init__(
            "provider-boilerplate", resource_name, __props__, opts
        )
