...
namespace Axnic.Pulumi.Garage
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/axnic/pulumi-garage";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Axnic.Pulumi.Garage.version.txt");
    ...
    internal sealed class GarageResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public GarageResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
